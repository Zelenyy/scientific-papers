...
\begin{frame}
    ...
    \begin{figure} \centering
        ...
        \node (fig1) at (10,4){ \centering\includegraphics[width=0.8\paperwidth]{draw.pdf}
        };
...
{\large     		\begin{itemize}
        ...
        \node[text width=6cm] (fig3) at (65,60){
{\large             \begin{itemize}
...
{\large     This model is implemented as program on Kotlin programming language.}
    \flushright{\flushbottom\includegraphics[width=0.3\paperwidth]{kotlin.pdf}}
