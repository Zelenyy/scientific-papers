...
\begin{document}
    ...
    When discussing light\revision{n}ing breakdown, it is important to compute not only number of breakdown electrons, but also the total number of electrons and ions generated. This number could be very roughly estimated from energy conservation law. 
