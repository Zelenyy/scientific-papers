...
\begin{figure}[t]
    \begin{center} 
        ...
        \vspace{-3mm}
        \caption{a) Энергетические спектры различных материалов (общий вид) 
        b) Энергетические спектры различных материалов (область с энергией более 4 МэВ)
    \end{center}
    \labelf{fig01}
    \vspace{-5mm}
\end{figure}
\begin{figure}[t]
    \begin{center}
        ...
        \vspace{-3mm}
        \caption{a) Зависимость метрики от эффективного заряда материала
 b) Сравнение энергетических спектров от уранового и алюминиевого шарика}
    \end{center}
    \labelf{pic:diff}
    \vspace{-5mm}
\end{figure}
