...
\author{\firstname{Mikhail} \lastname{Zelenyi}\inst{1,2}\fnsep\thanks{\email{mihail.zelenyy@phystech.edu}} \and
    \firstname{Maria} \lastname{Polyakova}\inst{1,2} \and \firstname{Alexander} \lastname{Nozik}\inst{1,2}\fnsep\thanks{\email{altavir@gmail.com}} \and \firstname{Alexey} \lastname{Khudyakov}\inst{1}\fnsep\thanks{\email{alexey.skladnoy@gmail.com}}  
    }
%
